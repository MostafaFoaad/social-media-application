import { FACEBOOK_LINK, INSTEGRAM_LINK, TWITTER_LINK } from "../../../config/config.js";

export const verifyEmailTemplate = ({code, title}:{code:number,title:string}):string => {
  return `<!DOCTYPE html>
                <html>
                <head>
                ...
                <a href="${INSTEGRAM_LINK}" style="text-decoration: none;"><span class="twit" style="padding:10px 9px;color:#fff;border-radius:50%;">
